      ...
      <div className="relative z-10 p-4 sm:p-8">
        ...
        {!loading && reports.length === 0 ? (
          <motion.div 
            ...
            transition={{ duration: 0.5 }}
            className="flex flex-col items-center justify-center p-12 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl shadow-2xl backdrop-blur-xl text-center relative overflow-hidden group"
          >
            {/* Card Glow */}
            <div className="absolute -inset-4 bg-gradient-to-r from-purple-600/20 via-pink-600/20 to-cyan-600/20 rounded-3xl blur-xl" />
            
            <div className="relative z-10">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-600/20 via-pink-600/20 to-indigo-600/20 rounded-full flex items-center justify-center mb-6 mx-auto backdrop-blur-sm border border-white/10 group-hover:scale-110 transition-transform duration-300">
              ...
              <Link
                href="/reports"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:shadow-2xl hover:shadow-purple-500/30 transition-all hover:scale-105 active:scale-95 shadow-lg group/btn relative overflow-hidden"
              >
                {/* Button Shine */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-1000" />
                <Plus className="w-5 h-5 relative z-10" />
                <span className="relative z-10">Generate first report</span>
              </Link>
            </div>
          </motion.div>
        ) : (
